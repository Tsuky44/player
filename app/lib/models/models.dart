class User {
  ...
  /// True for the first account created on the server, which is the one
  /// allowed to manage the server itself (installers, …). Absent on older
  /// servers, where nobody gets the admin UI.
  final bool isAdmin;
